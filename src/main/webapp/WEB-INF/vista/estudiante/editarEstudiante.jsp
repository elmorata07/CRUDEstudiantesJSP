...
<html>
    ...
    <body>
        ...
        <form action="${pageContext.request.cotextPath}/ServletControlador?action=modificar&edEstudiante=${estudiante.idEstudiante}
              method="post" class="was-validated">
            <jsp:include page="../componentes/botnoesNavegacionEdicion.jsp/"/>
            <section id="details">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-deader">
